...
export const settings: NamespaceMessages = {
  zh: {
    ...
    providerSuchuangDesc: "多模型 AI 平台，可接入国内外图像与视频生成模型",
    providerSuchuangTip: "内置异步任务适配；新模型可在生成设置中直接补充模型 ID",
    ...
    modelListFailed: "读取模型列表失败，请检查服务地址和密钥后重试，也可手动填写模型名称。",
    modelListEmpty: "此服务没有返回可用模型，你仍可手动填写模型名称。",
    ...
    ttsTitle: "配音 TTS",
    ttsSubtitle:
      "开启后合成会为每个分镜生成口播配音（火山语音 V3 · 豆包 Seed TTS）",
  ...
  en: {
    ...
    providerSuchuangDesc: "A multi-model AI platform for domestic and international image and video models",
    providerSuchuangTip: "Async task adapter included; add newly released model IDs directly in Generation Settings",
    ...
    modelListFailed: "Could not read the model list. Check the endpoint and key, then retry, or enter a model name manually.",
    modelListEmpty: "This service returned no models. You can still enter a model name manually.",
    ...
    ttsSubtitle:
      "When enabled, composition generates a spoken voiceover for each shot (Volcengine Speech V3 · Doubao Seed TTS)",
