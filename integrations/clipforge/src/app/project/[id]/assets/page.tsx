...
import { enabledMainPgMediaProviders, mergeCustomModels, buildImageOptions, buildVideoOptions, toEditVariant } from "@/lib/gen-params";
...
export default function AssetsPage() {
  ...
  const enabledCatalogProviders = enabledMainPgMediaProviders(providers);
