...
class ProfitSettings:
    ...
    save_root: str = ""
    # Legacy shared fields are retained for callers upgrading from the old API.
    ...
    us_domestic_fee: Decimal = Decimal("2.5")
    us_shipping_subsidy: Decimal = Decimal("21")
    us_refund_rate: Decimal = Decimal("0.05")
    co_first_mile_rate: Decimal = Decimal("70")
    co_first_mile_fixed: Decimal = Decimal("0")
    co_domestic_fee: Decimal = Decimal("2.5")
    co_shipping_subsidy: Decimal = Decimal("21")
    co_refund_rate: Decimal = Decimal("0.05")
    ...
    pe_first_mile_rate: Decimal = Decimal("80")
    pe_first_mile_fixed: Decimal = Decimal("0")
    pe_domestic_fee: Decimal = Decimal("2.5")
    pe_shipping_subsidy: Decimal = Decimal("21")
    pe_refund_rate: Decimal = Decimal("0.05")
