...
CREATE TABLE IF NOT EXISTS profit_activity_settings (
    ...
    us_first_mile_rate NUMERIC(12, 4) NOT NULL DEFAULT 0,
    us_first_mile_fixed NUMERIC(12, 4) NOT NULL DEFAULT 0,
    co_first_mile_rate NUMERIC(12, 4) NOT NULL DEFAULT 0,
    co_first_mile_fixed NUMERIC(12, 4) NOT NULL DEFAULT 0,
    ec_domestic_fee NUMERIC(12, 4) NOT NULL DEFAULT 0,
    ec_shipping_subsidy NUMERIC(12, 4) NOT NULL DEFAULT 0,
    ec_shipping_subsidy_price_limit NUMERIC(12, 4) NOT NULL DEFAULT 0,
    ec_first_mile_rate NUMERIC(12, 4) NOT NULL DEFAULT 0,
