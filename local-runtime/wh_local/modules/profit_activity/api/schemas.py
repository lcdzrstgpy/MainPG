...
class SettingsPayload(_StrictModel):
    ...
    us_domestic_fee: Decimal = Field(ge=0)
    us_shipping_subsidy: Decimal = Field(ge=0)
    us_refund_rate: Decimal = Field(ge=0, le=1)
    co_first_mile_rate: Decimal = Field(ge=0)
    co_first_mile_fixed: Decimal = Field(ge=0)
    co_domestic_fee: Decimal = Field(ge=0)
    co_shipping_subsidy: Decimal = Field(ge=0)
    co_refund_rate: Decimal = Field(ge=0, le=1)
