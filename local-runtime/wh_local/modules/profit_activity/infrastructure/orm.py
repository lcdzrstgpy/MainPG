...
class ProfitSettingsRow(Base):
    ...
    co_first_mile_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), nullable=False, default=Decimal("70"))
    ...
    pe_first_mile_rate: Mapped[Decimal] = mapped_column(Numeric(12, 4), nullable=False, default=Decimal("80"))
    pe_first_mile_fixed: Mapped[Decimal] = mapped_column(Numeric(12, 4), nullable=False, default=Decimal("0"))
    pe_domestic_fee: Mapped[Decimal] = mapped_column(Numeric(12, 4), nullable=False, default=Decimal("2.5"))
    pe_shipping_subsidy: Mapped[Decimal] = mapped_column(Numeric(12, 4), nullable=False, default=Decimal("21"))
    pe_refund_rate: Mapped[Decimal] = mapped_column(Numeric(10, 6), nullable=False, default=Decimal("0.05"))
