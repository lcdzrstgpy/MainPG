...
def create_app(database_path: Path | None = None) -> FastAPI:
    ...
    app.include_router(create_product_processing_router(product_processing, customer_sessions=customer_sessions, remote_customer_auth=remote_customer_auth))
    ...
    app.include_router(create_product_processing_router(product_processing, customer_sessions=customer_sessions, remote_customer_auth=remote_customer_auth), prefix="/api")
