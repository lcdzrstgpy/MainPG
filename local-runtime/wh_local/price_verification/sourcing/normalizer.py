...
def normalize_source_candidate(
    ...
    return {
        ...
        "history_lookup": bool(raw_candidate.get("history_lookup")),
        "history_task_id": raw_candidate.get("history_task_id"),
        "history_item_id": raw_candidate.get("history_item_id"),
        "matched_history_title": _first_text(raw_candidate, "matched_history_title"),
