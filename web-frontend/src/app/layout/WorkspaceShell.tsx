    ...
    <main className="workspace-shell">
      ...
      <section className="workspace-main">
        ...
        <div className="content-card">
          {activeId === "dashboard" ? <WorkspaceHomePage onOpenModule={openModule} /> : activeId === "profit_activity" ? <ProfitActivityTestPage /> : activeId === "basic_settings" ? <BasicSettingsPage /> : <EmptyModulePage module={activeModule} />}
        </div>
      </section>
    </main>
  );
