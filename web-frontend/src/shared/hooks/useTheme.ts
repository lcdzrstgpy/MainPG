...
export type ThemeId = "classic" | "sunset" | "violet" | "diamond" | "quirky" | "chinese";
...
function readTheme(): ThemeId {
  try {
    ...
    if (saved === "sunset" || saved === "violet" || saved === "diamond" || saved === "quirky" || saved === "chinese" || saved === "classic") return saved;
  } catch { /* ignore */ }
  return "classic";
}
