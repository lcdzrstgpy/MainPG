...
export const priceVerificationApi = {
  ...
  sourceBatchSelections: (batchId: string, rankingMode: "similarity" | "price" = "similarity", skcIds?: string[]) => httpJson<SourcePreview>(`${base}/capture-batches/${encodeURIComponent(batchId)}/sourcing`, { method: "POST", body: { idempotency_key: key(), ranking_mode: rankingMode, skc_ids: skcIds ?? [] } }),
