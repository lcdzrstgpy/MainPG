...
export const priceVerificationApi = {
  ...
  activateCaptureBatch: (batchId: string) => httpJson<QuoteCaptureBatch>(`${base}/capture-batches/${encodeURIComponent(batchId)}/activate`, { method: "POST" }),
    ...
    setCaptureBatchArchiveProductIdType: (batchId: string, archiveProductIdType: "SKU" | "SKC" | "SPU") => httpJson<QuoteCaptureBatch>(`${base}/capture-batches/${encodeURIComponent(batchId)}/archive-product-id-type`, { method: "PUT", body: { archive_product_id_type: archiveProductIdType } }),
