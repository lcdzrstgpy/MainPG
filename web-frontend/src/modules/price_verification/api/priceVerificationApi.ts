...
export const priceVerificationApi = {
  ...
  linkSkcSource: (batchId: string, payload: { skc_id: string; offer_id: string; source_url: string; source_title?: string; main_image_url?: string; price_cny?: string | number | null; moq?: string | number | null; domestic_freight_cny?: string | number | null; source_decision?: string }) => httpJson<SkcSourceLink>(`${base}/capture-batches/${encodeURIComponent(batchId)}/skc-source-links`, { method: "POST", body: payload }),
